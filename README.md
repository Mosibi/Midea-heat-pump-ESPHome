...
## ESPHome Midea Controller

Together with my son [Sven](https://svenar.nl) who is an electronics student, we created an ESPHome board which is ready to connect to an Midea heat pump. The current phase of that project is that we have our first prototype which is controlling the heat pump in our house now.

![Prototype 1](pictures/midea_controller_prototype_1.jpeg)

In the future we like to offer this as a complete solution.
